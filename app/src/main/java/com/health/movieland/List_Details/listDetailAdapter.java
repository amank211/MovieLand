package com.health.movieland.List_Details;
...
public class listDetailAdapter extends RecyclerView.Adapter<listDetailAdapter.trending_all_ViewHolder>{
    private Context context;
    private List<Item> data;

    public listDetailAdapter(Context context, List<Item> data){
        this.context = context;
        this.data = data;
    }

    @Override
    public listDetailAdapter.trending_all_ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        return new listDetailAdapter.trending_all_ViewHolder(view);

    }


    @Override
    public void onBindViewHolder(@NonNull final listDetailAdapter.trending_all_ViewHolder holder, int position) {
        final Item movie = data.get(position);
