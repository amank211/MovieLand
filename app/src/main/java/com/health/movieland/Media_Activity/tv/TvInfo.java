...
public class TvInfo {
    ...
    @Expose
    private List<Genre_tv> genres = null;
    ...
    @Expose
    private List<com.health.movieland.Media_Activity.ProductionCompany> productionCompanies = null;
    ...
    public List<Genre_tv> getGenres() {
        return genres;
    }

    public void setGenres(List<Genre_tv> genres) {
        this.genres = genres;
    }
    ...
    public List<com.health.movieland.Media_Activity.ProductionCompany> getProductionCompanies() {
